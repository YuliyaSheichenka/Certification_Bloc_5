...
experiment_name="xgboost_regressor"
...
model = Pipeline(steps=[
    ...
    ("Regressor", XGBRegressor(max_depth=8, min_child_weight=13, n_estimators=55))
    ])
...
with mlflow.start_run(experiment_id = experiment.experiment_id):
    ...
    mlflow.sklearn.log_model(
            ...
            registered_model_name="getaround_xbgoost_regressor",
